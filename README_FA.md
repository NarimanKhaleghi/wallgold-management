...
| تحلیل و نمودارها | تنظیمات — تب‌بندی مرتب |
|:---:|:---:|
| ![تحلیل](docs/screenshots/13-analytics.png) | ![تنظیمات](docs/screenshots/14-settings-general.png) |
| *تاریخچه قیمت، ارزش دارایی، سود و زیان معاملات* | *حساب‌ها / عمومی / امنیت* |
